...
""" mw-joystick.py: Send joystick commands via UDP"""
...
serI = raw_input("ingrese su serial port (para conocerlo: sudo ls /dev/tty*) ej:/dev/ttyUSB0  ")
vehicle = MultiWii(serI)
    ...
    try:
        while True:
            if udp.active:
                ...
                rcCMD[2] = udp.message[2] # Pitch
                rcCMD[1] = udp.message[1] # Yaw
        ...
        print "Error en envio de comandos thread: "+str(error)
        sendCommands()
...
if __name__ == "__main__":
    try:
        ...
        print "Error en prog principal: "+str(error)
        vehicle.ser.close()
    except KeyboardInterrupt:
        print "Teclado Interrupcion, saliendo."
        exit()
